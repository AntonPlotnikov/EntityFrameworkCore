...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class ShapedQueryExpression : Expression
    {
        ...
        public override Expression Reduce()
        {
            return Call(
                null,
                typeof(ShapedQueryExpression).GetTypeInfo().GetDeclaredMethod(nameof(ShapedQuery)).MakeGenericMethod(_returnType),
        ...
        public override string ToString()
        {
            ...
            var sql = querySqlGenerator.GenerateSql(new Dictionary<string, object>());
