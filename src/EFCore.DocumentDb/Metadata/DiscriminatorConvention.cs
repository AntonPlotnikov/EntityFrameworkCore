...
namespace Microsoft.EntityFrameworkCore.Metadata
{
    public class DiscriminatorConvention : IBaseTypeChangedConvention
    {
        public virtual bool Apply(InternalEntityTypeBuilder entityTypeBuilder, EntityType oldBaseType)
        {
            ...
            {
                if (entityTypeBuilder.DocumentDb(ConfigurationSource.Convention).HasDiscriminator(propertyInfo: null) == null)
                {
                ...
                discriminator = rootTypeBuilder?.DocumentDb(ConfigurationSource.Convention).HasDiscriminator(typeof(string));
